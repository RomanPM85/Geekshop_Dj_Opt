...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        action_2__condition = Q(order__update__gt=F('order__create') + action_1__time_delta) & Q(
            order__update__lte=F('order__create') + action_2__time_delta)
        ...
        """ annotate позволяет разбавить функционал, добавить свои поля """
